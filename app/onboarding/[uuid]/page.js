                            ...
                            <div className="max-w-4xl mx-auto p-4 sm:p-8">
                                {currentStep === 0 && (
                                    <div className="text-center space-y-4">
                                        ...
                                        <p className="text-lg text-gray-600">
                                            Let's set up your new digital
                                            business card. It'll only take a
                                            minute.
                                        </p>
                                ...
                                {currentStep === 2 && (
                                    <div className="space-y-6">
                                        <div className="text-center">
                                            ...
                                            <p className="text-gray-500 mt-1">
                                                Upload a profile picture and a
                                                banner to make your card stand
                                                out.
                                            </p>
                                        </div>
                                        <CardImageUploader
                                ...
                                {currentStep === 3 && (
                                    <div className="space-y-6">
                                        <div className="text-center">
                                            ...
                                            <p className="text-gray-500 mt-1">
                                                Add a short bio to introduce
                                                yourself to your connections.
                                            </p>
                                        </div>
                                        <BioForm />
                                    </div>
                                ...
                                {currentStep === 5 && (
                                    <div className="space-y-6">
                                        <div className="text-center">
                                            ...
                                            <p className="text-gray-500 mt-1">
                                                Have a portfolio, project, or
                                                something else to share? Add it
                                                here.
                                            </p>
                                        </div>
                                        <OtherLinksForm
                                ...
                                {currentStep === 6 && (
                                    <div className="text-center space-y-4">
                                        ...
                                        <p className="text-lg text-gray-600">
                                            Here's a final preview of your card.
                                            Ready to go live?
                                        </p>
                                        <div className="mt-8 max-w-md mx-auto">
